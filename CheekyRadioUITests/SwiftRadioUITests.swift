...
//
// Cheeky Radio Pro
// repackaged by cheekyfactor.com 2019.
...
class CheekyRadioUITests: XCTestCase {
    
    let app = XCUIApplication()
    let stations = XCUIApplication().cells
    let hamburgerMenu = XCUIApplication().navigationBars["Cheeky Radio"].buttons["icon hamburger"]
    ...
    func testMainStationsView() {
        ...
        app.navigationBars["Cheeky Radio"].buttons["btn nowPlaying"].tap()
        waitForStationToLoad()
